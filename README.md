...
| 14 | [Aspect-Oriented Programming](docs/Aspect-Oriented-Programming.md) | AOP, AOP Weaving types, AspectJ vs Spring AOP                      | Pillars of OOP, Java Core, Spring Core       |
| 15 | [REST Basics](docs/REST-Basics.md)                                 | REST constraints, HTTP methods, status codes                       | —                                            |
| 16 | [REST with Spring](docs/REST-With-Spring.md)                       | Spring MVC/REST annotations, request lifecycle, dispatcher servlet | Spring Core, REST Basics                     |
| 17 | [REST API Documentation](docs/REST-API-Documentation.md)           | Swagger, OpenAPI, Postman                                          | REST with Spring                             |
| 18 | [Microservices](docs/Microservices.md)                             | Monolithic vs microservices, service communication, patterns       | REST with Spring, Databases, Design Patterns |